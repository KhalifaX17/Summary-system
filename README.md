...
ต้องมีอย่างน้อย `GOOGLE_SERVICE_ACCOUNT_EMAIL`, `GOOGLE_PRIVATE_KEY` และ
`GOOGLE_SHEET_ID` เพื่อให้ระบบอ่าน/เขียนข้อมูลใน Google Sheet จริงได้
ส่วน `GOOGLE_DRIVE_FOLDER_ID` ใช้สำหรับอัปโหลดไฟล์แนบ หากยังไม่ตั้งค่า
ระบบจะยังใช้ข้อมูลตัวอย่างสำหรับไฟล์แนบเท่านั้น
