...
export default function Topbar({
  ...
  return (
    <div className="h-[76px] bg-surface border-b border-border flex items-center justify-between px-5 sm:px-6 md:px-8 shrink-0">
      <div>
        <h1 className="font-display font-semibold text-[21px] leading-none">{title}</h1>
        <div className="text-[14px] text-muted mt-1.5">{subtitle}</div>
      </div>
      {!hideAdd && (
        <Link
          href="/projects/new"
