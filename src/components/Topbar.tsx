...
export default function Topbar({
  ...
  return (
    <div className="h-[64px] bg-surface border-b border-border flex items-center justify-between px-5 sm:px-6 md:px-8 shrink-0">
      <div>
        <h1 className="font-display font-semibold text-[19px] leading-none">{title}</h1>
